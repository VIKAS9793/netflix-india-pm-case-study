...
1. Read `research/executive-summary.md` first (10 min)
...
|-----------|-----------|--------|
| Strategic Frameworks | 0.85 | ✅ Sound methodology |
| Verified Market Facts | 0.95 | ✅ Properly sourced |
| Competitive Analysis | 0.60 | ⚠️ Analyst estimates |
| User Behavior Patterns | 0.45 | [ASSUMPTION] based |
| Financial Projections | 0.40 | [SCENARIO] modeling |

**Appropriate for**: Learning, discussion, framework practice  
**Not appropriate for**: Production deployment, investment decisions
...
- **Always cite as**: "Hypothetical educational case study"
...
- **Frame as**: "Learning project demonstrating PM methodology"
...
This is a learning resource. Contributions welcome for:
...
Key sources include:
- Netflix investor relations (earnings calls)
...
- Marty Cagan's "Inspired" (product vision)
- Melissa Perri's "Escaping the Build Trap" (outcomes focus)
...
- **v1.0**: Original research (contained untagged assumptions - superseded)
